...
2. Create the Convex data model for dashboard and realtime analytics.
...
3. Add Convex functions for app reads/writes and AI-backed classification.
...
4. Replace the starter page with a realtime dashboard.
...
5. Add a web-based extension linking flow.
